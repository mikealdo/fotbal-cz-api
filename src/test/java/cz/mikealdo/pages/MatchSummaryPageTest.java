...
import static cz.mikealdo.football.domain.GoalType.GOAL;
import static org.junit.Assert.*;

public class MatchSummaryPageTest {
	
	MatchSummaryPage page  = new MatchSummaryPage();
	...
	public void shouldFillMatchSummaryWithRelevantData() throws Exception {
		Document document = page.getDocumentFor(html);
	...
	private void assertSquadMember(String name, String fotbalCzId, SquadMember squadMember) {
		...
		assertEquals(Integer.valueOf(fotbalCzId), squadMember.getId());
	}
